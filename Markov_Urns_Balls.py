...
if __name__ == "__main__":
    ...
    #initialize med uniform probability
    ...
    DG = nx.DiGraph()
    DG.add_edge(2, 1,weight=p[0,1])   # adds the nodes in order 2, 1
    DG.add_edge(1, 2,weight=p[1,0])
    DG.add_edge(1,3,weight=p[2,0])
    DG.add_edge(3,1,weight=p[0,2])
    DG.add_edge(2,3,weight=p[2,1])
    DG.add_edge(3,2,weight=p[1,2])
